...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1000, 700), keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        ...
        classes='./data/annotations/classes.txt'),
    val=dict(
        type='CocoDataset',
...
classes = './data/annotations/classes.txt'
optimizer = dict(type='SGD', lr=0.001, momentum=0.95, weight_decay=0.0001)
optimizer_config = dict(grad_clip=None)
lr_config = dict(
    policy='cyclic',
    target_ratio=(25, 0.025),
    cyclic_times=1,
    step_ratio_up=0.4)
